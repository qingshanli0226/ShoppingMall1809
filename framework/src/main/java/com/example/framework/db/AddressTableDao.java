...
public class AddressTableDao extends AbstractDao<AddressTable, Void> {
    ...
    /**
     * Properties of entity AddressTable.<br/>
    ...
    public AddressTableDao(DaoConfig config) {
        super(config);
    }
    
    public AddressTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ADDRESS_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, AddressTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AddressTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public AddressTable readEntity(Cursor cursor, int offset) {
        AddressTable entity = new AddressTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, AddressTable entity, int offset) {
