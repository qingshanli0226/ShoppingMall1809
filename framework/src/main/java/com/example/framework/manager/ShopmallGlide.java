...
public class ShopmallGlide {
    ...
    public void init(Context context) {
        ...
        cacheFileDir = new File(context.getExternalCacheDir().getAbsoluteFile() + "/shopmall/");
            ...
            public void run() {
                synchronized (diskLruCache) {
                    ...
                    try {
                        ...
                        bitmap.compress(Bitmap.CompressFormat.JPEG, 100, outputStream);//bitmap产生的文件是JPEG的格式，且质量没有压缩
                        editor.commit();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                ...
                try {
                    ...
                    if (response.body() == null) {
                        ...
                        if (inputStream == null) {
                            ...
                            originalBitmap=null;
                            setBitmapToDisk(url,bitmap);//存到sd卡
