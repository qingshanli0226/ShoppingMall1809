...
public class NetworkConnectionsManager {
    ...
    private static NetworkConnectionsManager instance;

    private List<IConnectListener> connectListenerList = new LinkedList<>();

    private NetworkConnectionsManager(){

    }

    public static synchronized NetworkConnectionsManager getInstance() {
        if (instance==null) {
            instance = new NetworkConnectionsManager();
        }
        return instance;
    }
