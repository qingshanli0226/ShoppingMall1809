...
public class HomePduHotAdapter extends BaseAdapter<KindHomeProductsBean.ResultBean.HotProductListBean> {
    @Override
    ...
    @Override
    public void displayViewHolder(BaseViewHolder baseViewHolder, int position, KindHomeProductsBean.ResultBean.HotProductListBean itemData) {
