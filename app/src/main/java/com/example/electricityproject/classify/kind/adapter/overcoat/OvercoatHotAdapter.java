...
public class OvercoatHotAdapter extends BaseAdapter<KindOvercoatBean.ResultBean.HotProductListBean> {
    @Override
    ...
    @Override
    public void displayViewHolder(BaseViewHolder baseViewHolder, int position, KindOvercoatBean.ResultBean.HotProductListBean itemData) {
