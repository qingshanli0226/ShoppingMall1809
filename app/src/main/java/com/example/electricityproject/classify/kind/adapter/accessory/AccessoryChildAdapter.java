...
public
class AccessoryChildAdapter extends BaseAdapter<KindAccessoryBean.ResultBean.ChildBean> {
    @Override
    ...
    @Override
    public void displayViewHolder(BaseViewHolder baseViewHolder, int position, KindAccessoryBean.ResultBean.ChildBean itemData) {
