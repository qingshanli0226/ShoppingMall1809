package com.example.electricityproject.classify.kind.adapter.game;
...
public
class GameChildAdapter extends BaseAdapter<KindGameBean.ResultBean.ChildBean> {
    @Override
    ...
    @Override
    public void displayViewHolder(BaseViewHolder baseViewHolder, int position, KindGameBean.ResultBean.ChildBean itemData) {
