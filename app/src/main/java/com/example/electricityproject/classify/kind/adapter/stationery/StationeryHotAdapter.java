...
public class StationeryHotAdapter extends BaseAdapter<KindStationeryBean.ResultBean.HotProductListBean> {
    @Override
    ...
    @Override
    public void displayViewHolder(BaseViewHolder baseViewHolder, int position, KindStationeryBean.ResultBean.HotProductListBean itemData) {
