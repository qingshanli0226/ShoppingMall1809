...
public class TypeFourAdapter<T> extends BaseRecyclerViewAdapter<T> {
    public TypeFourAdapter(List<T> list1) {
        updataData(list1);
    }
    ...
    public void displayViewHolder(BaseViewHolder holder, int position, T itemData) {
        AccessoryBean.ResultBean.ChildBean listBeans = (AccessoryBean.ResultBean.ChildBean) itemData;
