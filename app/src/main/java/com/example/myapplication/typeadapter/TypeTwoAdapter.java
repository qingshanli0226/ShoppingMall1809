...
public class TypeTwoAdapter<T> extends BaseRecyclerViewAdapter<T> {
    public TypeTwoAdapter(List<T> list1) {
        updataData(list1);
    }
    ...
    public void displayViewHolder(BaseViewHolder holder, int position, T itemData) {
        PantsBean.ResultBean.ChildBean listBeans = (PantsBean.ResultBean.ChildBean) itemData;
