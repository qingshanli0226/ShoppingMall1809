...
public class TypeSevAdapter<T> extends BaseRecyclerViewAdapter<T> {
    public TypeSevAdapter(List<T> list1) {
        updataData(list1);
    }
    ...
    public void displayViewHolder(BaseViewHolder holder, int position, T itemData) {
        HomeProductBean.ResultBean.ChildBean listBeans = (HomeProductBean.ResultBean.ChildBean) itemData;
