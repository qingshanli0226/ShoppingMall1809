...
public class TypeFiveAdapter<T> extends BaseRecyclerViewAdapter<T> {
    public TypeFiveAdapter(List<T> list1) {
        updataData(list1);
    }
    ...
    public void displayViewHolder(BaseViewHolder holder, int position, T itemData) {
        BagBean.ResultBean.ChildBean listBeans = (BagBean.ResultBean.ChildBean) itemData;
