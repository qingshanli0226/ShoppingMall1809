...
public class ShipmentAdapter extends BaseRvAdapter<ShipmentBean.ResultBean> {
    ...
    @Override
    protected void displayViewHolder(BaseViewHolder holder, int position, ShipmentBean.ResultBean itemView) {
